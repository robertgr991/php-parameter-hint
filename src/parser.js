...
class Parser {
  ...
  parseObject(obj) {
    ...
    if (obj.kind) {
      ...
      if (
        ["function", "method", "catch", "closure", "arrowfunc"].includes(
          obj.kind,
        )
      ) {
      ...
      if (["expressionstatement"].includes(obj.kind)) {
        if (Array.isArray(obj.expression)) {
          ...
          obj.expression && obj.expression.left &&
            this.parseObject(obj.expression.left);
          obj.expression && obj.expression.right &&
            this.parseObject(obj.expression.right);
          obj.expression &&
            !obj.expression.left &&
            this.parseObject(obj.expression);
        }
      ...
      if (["for"].includes(obj.kind)) {
        ...
        if (Array.isArray(obj.increment)) {
          ...
          obj.increment && obj.increment.left &&
            this.parseObject(obj.increment.left);
          obj.increment && obj.increment.right &&
            this.parseObject(obj.increment.right);
        }
  ...
  parseArguments(obj) {
    ...
    if (
      phpFunctionGroup.args.length && obj.what && obj.what.kind !== "variable"
    ) {
